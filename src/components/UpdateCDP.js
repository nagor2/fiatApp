...
export default class UpdateCDP extends React.Component{
    constructor(props){
        ...
        this.state={loader: false, maxCoins:0, amount:parseFloat(this.props.position.coinsMinted)/10**18, collateral:parseFloat(this.props.position.ethAmountLocked)/10**18, buttonIsActive: false, balance:0};
    }

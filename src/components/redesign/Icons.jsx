...
export default function Icon({ name, size = 20, ...rest }) {
  ...
  switch (name) {
    ...
    case 'arrows':   return <svg {...props}><path d="m7 7 10 10"/><path d="M7 17V7h10"/><path d="m7 17 10-10"/></svg>;
    ...
    case 'token':    return <svg {...props}><circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="3.5"/></svg>;
    case 'arrow-down-left': return <svg {...props}><path d="M17 7 7 17"/><path d="M15 17H7v-8"/></svg>;
    case 'loan':     return <svg {...props}><path d="M4 8a4 4 0 0 1 4-4h8a4 4 0 0 1 4 4v8a4 4 0 0 1-4 4H8a4 4 0 0 1-4-4z"/><path d="M9 12h6"/><path d="M12 9v6"/><circle cx="12" cy="12" r="0.5" fill="currentColor"/></svg>;
